    ...
    <main className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-12 space-y-8">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Política de comisiones y cancelaciones</p>
        </div>
        ...
        <section className="space-y-3">
          ...
          <div className="rounded-lg border bg-card p-4 text-sm text-foreground/60 space-y-2">
