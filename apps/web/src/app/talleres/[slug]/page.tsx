...
import { MapPin, Calendar, Clock, CheckCircle, Instagram, Facebook, Globe, Phone, MessageCircle, Tag, Users } from "lucide-react";
        ...
        {hasContacts && (
          <div className="flex flex-wrap items-center gap-3 mt-2">
            ...
            {ins.website && (
              <a
                href={
                  ins.website.startsWith("http://") || ins.website.startsWith("https://")
                    ? ins.website
                    : `https://${ins.website}`
                }
                target="_blank"
