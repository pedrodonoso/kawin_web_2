...
CREATE TABLE bookings (
  ...
  commission_absorbed_by   VARCHAR(20),  -- 'instructor' | 'platform'
  cancelled_reason         VARCHAR(50),  -- 'schedule_change' | 'instructor_cancel' | 'student_request'
...
-- IDs secuenciales para facilitar depuración y referencias cruzadas
